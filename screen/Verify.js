    ...
    return (
        <View style={{ paddingTop: 80, paddingLeft: 20, paddingRight: 20, backgroundColor: '#fff', width, height, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', marginTop: height / 15 }}>
                <TextInput keyboardType='number-pad' style={{ flex: 0.1, fontSize: 15, borderWidth: 1,alignSelf: 'center',paddingTop: 10, height: 40, paddingLeft: 15, marginRight: 8 }} />
                <TextInput keyboardType='number-pad' style={{ flex: 0.1, fontSize: 15, borderWidth: 1,alignSelf: 'center', marginLeft: 8, paddingTop: 10, height: 40, paddingLeft: 15, marginRight: 8 }} />
                <TextInput keyboardType='number-pad' style={{ flex: 0.1, fontSize: 15, borderWidth: 1,alignSelf: 'center', marginLeft: 8, paddingTop: 10, height: 40, paddingLeft: 15, marginRight: 8 }} />
                <TextInput keyboardType='number-pad' style={{ flex: 0.1, fontSize: 15, borderWidth: 1,alignSelf: 'center', marginLeft: 8, paddingTop: 10, height: 40, paddingLeft: 15,  }} />
            </View>
            <View style={{ marginBottom: height / 3, width: width / 1.24, marginTop: height / 12 }}>
                <Button title='Verify' style={{ borderRadius: 10 }} color={'#06a10e'} onPress={() => navigation.navigate('home')} />
